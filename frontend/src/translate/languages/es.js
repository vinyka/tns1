  ...
  es: {
    translations: {
      ...
      qrCode: {
        ...
        instructions: {
          title: "Cómo conectar el WhatsApp de tu empresa",
          step1: "Abre el WhatsApp de la empresa en el teléfono.",
          step2:
            "En Android toca Más opciones (⁝); en iPhone toca Configuración.",
          step3: "Selecciona 'Dispositivos vinculados'.",
          step4:
            "Toca 'Vincular un dispositivo' y apunta la cámara del teléfono al código QR de arriba.",
        },
      },
      contacts: {
        title: "Contactos",
      ...
      mainDrawer: {
        ...
        footerWarning: {
          title: "Conecta el WhatsApp de tu empresa para usar ZapRun",
          description:
            "Entra a la página de conexiones usando el botón al lado y haz clic en NUEVO QR-CODE, luego sigue las instrucciones.",
          help: "Mientras tanto no se enviarán ni recibirán mensajes.",
          cta: "Ir a Conexiones",
        },
      },
      languages: {
      ...
      quickMessages: {
        ...
        dialog: {
          ...
          save: "Guardar",
          cancel: "Cancelar",
          geral: "Permitir edición del equipo",
          add: "Agregar",
          edit: "Editar",
          visao: "Compartir con el equipo",
        },
        table: {
          shortcode: "Atajo",
          message: "Mensaje",
