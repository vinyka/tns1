...
async function handleSendScheduledMessage(job) {
    ...
    try {
        ...
        if (schedule.mediaPath) {
            filePath = path_2.default.resolve("public", `company${schedule.companyId}`, schedule.mediaPath);
        }
            ...
            if (whatsapp.status === "CONNECTED") {
                if (campaign.confirmation && campaignShipping.confirmation === null) {
                    ...
                    if (campaign.mediaPath) {
                        ...
                        const filePath = path_2.default.join(publicFolder, `company${campaign.companyId}`, campaign.mediaPath);
