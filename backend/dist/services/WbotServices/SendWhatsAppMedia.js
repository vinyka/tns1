...
const getMessageOptions = async (fileName, pathMedia, companyId, body = " ") => {
    ...
    try {
        ...
        if (typeMessage === "video") {
            options = {
                video: fs_2.default.readFileSync(pathMedia),
            ...
            if (typeAudio) {
                options = {
                    audio: fs_2.default.readFileSync(convert),
                    mimetype: "audio/mp4",
                    ptt: true
                };
            }
            ...
            options = {
                document: fs_2.default.readFileSync(pathMedia),
                caption: body ? body : null,
                fileName: fileName,
                mimetype: mimeType
            };
            ...
            options = {
                image: fs_2.default.readFileSync(pathMedia),
                caption: body ? body : null,
            };
        }
        return options;
