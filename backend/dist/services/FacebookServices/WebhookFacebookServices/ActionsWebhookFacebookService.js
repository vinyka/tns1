        ...
        if (nodeSelected.type === "singleBlock") {
            for (var iLoc = 0; iLoc < nodeSelected.data.seq.length; iLoc++) {
                ...
                if (elementNowSelected.includes("img")) {
                    ...
                    const fileExtension = path_2.default.extname(mediaPath);
                    //Obtendo o nome do arquivo sem a extensão
                    const fileNameWithoutExtension = path_2.default.basename(mediaPath, fileExtension);
                    //Obtendo o tipo do arquivo
                ...
                if (elementNowSelected.includes("audio")) {
                    ...
                    // Obtendo o tipo do arquivo
                    const fileExtension = path_2.default.extname(mediaDirectory);
                    //Obtendo o nome do arquivo sem a extensão
                    const fileNameWithoutExtension = path_2.default.basename(mediaDirectory, fileExtension);
                    //Obtendo o tipo do arquivo
                    const mimeType = mime_1.default.lookup(mediaDirectory);
                    const fileNotExists = path_2.default.resolve(__dirname, "..", "..", "..", "..", "public", fileNameWithoutExtension + ".mp4");
                    if (fileNotExists) {
                        const folder = path_2.default.resolve(__dirname, "..", "..", "..", "..", "public", fileNameWithoutExtension + fileExtension);
