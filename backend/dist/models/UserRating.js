...
const Company_2 = __importDefault(require("./Company"));
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => Company_2.default),
    sequelize_typescript_1.Column,
    __metadata("design:type", Number)
], UserRating.prototype, "companyId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => Company_2.default),
    __metadata("design:type", Company_2.default)
